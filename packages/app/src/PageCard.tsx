...
const RichTextEditorSurface = memo(function RichTextEditorSurface({
  ...
  const contentCardClass =
    "rounded-[0.75rem] border border-[#E9E9E8] dark:border-[oklch(0.32_0_0)] bg-white dark:bg-[oklch(0.22_0_0)] shadow-[0_18px_44px_rgba(57,47,38,0.08)] dark:shadow-[0_22px_56px_rgba(0,0,0,0.55)]";
